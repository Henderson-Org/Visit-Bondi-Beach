...
- **Repository (resolved).** The site now lives in its own dedicated repo, `njhenderson-dev/Visit-Bondi-Beach`, decoupled from `japan-travel`. This risk is closed.
