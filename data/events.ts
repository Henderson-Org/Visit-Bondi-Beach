...
export const EVENTS: BondiEvent[] = [
  ...
  },
  {
    id: 'bondi-festival',
    slug: 'bondi-festival',
    title: 'Bondi Festival',
    summary: "Waverley Council's winter arts festival on Bondi Park - comedy, music, theatre and the beachfront ice rink.",
    description: [
      'Bondi Festival is Waverley Council’s annual July celebration across Bondi Park and the Bondi Pavilion: comedy, live music, theatre, light installations, family activities and free roaming performance, with the beachfront ice rink as its best-known drawcard.',
      'It is the modern continuation of what locals remember as Bondi Winter Magic. Most ticketed shows are modestly priced and a good deal of the program is free. Dates land in early-to-mid July; confirm the next edition on the official festival site.',
    ],
    timezone: 'Australia/Sydney',
    recurrence: { freq: 'annual', month: 7 },
    dateStatus: 'tbc',
    typicalTiming: 'A little over two weeks in July',
    nextEditionYear: 2027,
    whenText: 'Next edition July 2027 - dates to be announced',
    venue: 'Bondi Park and Bondi Pavilion',
    address: 'Queen Elizabeth Drive, Bondi Beach NSW 2026',
    suburb: 'Bondi Beach',
    categories: ['arts', 'family', 'community', 'music', 'seasonal'],
    audience: ['everyone', 'families'],
    priceType: 'varies',
    officialUrl: 'https://www.bondifestival.com.au/',
    ticketUrl: 'https://www.bondifestival.com.au/',
    image: null,
    organiser: 'Waverley Council',
    featured: false,
    status: 'scheduled',
    // The 2026 edition ran 3-19 July 2026 and has passed; 2027 dates are not yet published,
    // so TBC is accurate here rather than an asserted date. Flagged by scripts/verify-events.mjs.
    dateSourceUrl: 'https://www.bondifestival.com.au/',
    dateSourceName: 'Bondi Festival (official)',
  ...
  },
  {
    ...
    summary:
      "Sydney's Abbott World Marathon Major - it doesn't run through Bondi, but it takes over the city and fills our cafes with runners.",
    description: [
      'The TCS Sydney Marathon is a 42.195 km point-to-point from Miller Street in North Sydney, across the Sydney Harbour Bridge, finishing at the Sydney Opera House forecourt. It became the seventh Abbott World Marathon Major in 2025.',
    ...
    ticketUrl: 'https://www.tcssydneymarathon.com/',
    image: null,
    organiser: 'TCS Sydney Marathon',
    featured: true,
    status: 'scheduled',
    dateSourceUrl: 'https://media.destinationnsw.com.au/2026-abbott-world-major-tcs-sydney-marathon',
    dateSourceName: 'Destination NSW / TCS Sydney Marathon (official)',
    dateVerifiedAt: '2026-08-20',
    lastVerified: '2026-08-20',
    source: 'https://www.tcssydneymarathon.com/',
    relatedArticles: [
      { title: 'The TCS Sydney Marathon: a beginner’s guide', path: '/bondi-blog/2025/8/24/the-tcs-sydney-marathon-a-beginners-guide' },
      {
        title: 'Getting to the Sydney Marathon from Bondi Beach',
        path: '/bondi-blog/2024/9/7/getting-to-sydney-marathon-from-bondi-beach',
      },
      {
        title: 'Where to carb-load before the Sydney Marathon',
        path: '/bondi-blog/2025/8/9/the-best-places-to-carb-load-before-the-sydney-marathon',
      },
    ],
  },
  {
