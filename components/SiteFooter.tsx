    ...
    <footer className="mt-16 border-t border-sand-200 bg-sand-100">
      <div className="mx-auto max-w-6xl px-4 py-10 grid gap-8 sm:grid-cols-2 md:grid-cols-4">
        ...
        <nav aria-label="Footer" className="text-sm">
          <h2 className="font-medium text-ink-900 mb-2">Explore</h2>
        ...
        <div className="text-sm">
          <h2 className="font-medium text-ink-900 mb-2">Follow</h2>
          <a href={SITE.instagram} className="text-ink-500 hover:text-ocean-700">
            @visitbondibeach
          </a>
        </div>
      </div>
